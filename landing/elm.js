	...
	function (url, label) {
		return A2(
			_elm_lang$html$Html$a,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('list-group-item list-group-item-action justify-content-between'),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Main$headerStyle = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'padding-top', _1: '200px'},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'margin-bottom', _1: '20px'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'background', _1: 'rgb(255,255,255) url(https://storage.googleapis.com/aux-mars-backend-160319/537291165.jpg) 50% -30px no-repeat'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'background-size', _1: '650px auto'},
				_1: {ctor: '[]'}
			}
		}
	}
};
var _user$project$Main$formView = A2(
	...
	},
	{
		...
		_0: A2(
			_elm_lang$html$Html$input,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('form-control mb-2'),
					_1: {
						ctor: '::',
								...
								_0: _elm_lang$html$Html_Attributes$style(
									{
										...
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'padding', _1: '.5rem .75rem .4rem'},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'line-height', _1: '1.7'},
												_1: {ctor: '[]'}
											}
										}
									}),
					...
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('Company Name / Link'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$style(
											{
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(_user$project$Main$headerStyle),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('container mb-4'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Given how fast the world moves today, grabbing opportunities is more important than ever.'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('- Lean In, page 123'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$formView,
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('my-4 container'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Attributes$style(
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'margin', _1: '120px 0'},
											_1: {
												ctor: '::',
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Taking initiative pays off. It is hard to visualize someone as a leader if she is always waiting to be told what to do.'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('- Lean In, page 456'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Today’s world is different from 10 years ago. Very, very different.'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('container my-5'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$style(
												{
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Ten years ago: the iPhone didn’t exist. Cloud computing was unknown. Artificial Intelligence sounded like science fiction.'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Do you work for a company that doesn’t even have an app for its employees? Should’t every business have their own app?'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Do you want your team to benefit from apps, cloud computing, and yes, even artificial intelligence?'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Find Out How'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}),
