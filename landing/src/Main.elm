...
homepageUrl : String
homepageUrl =
  "/mars-frontend/skyveri-corp/homepage"
...
view model =
  div []
    ...
    , div [ class "my-4 container", style [ ( "text-align", "center" ) ] ]
        [ a [ class "btn btn-primary px-5 py-3", style [ ( "border-radius", "30px" ) ], href homepageUrl ] [ text "Get Started" ] ]
    ...
    , div [ class "container my-5", style [ ( "text-align", "center" ) ] ]
        [ a [ class "btn btn-primary px-5 py-3", style [ ( "border-radius", "30px" ), ( "margin-bottom", "80px" ) ], href homepageUrl ] [ text "Yep." ] ]
    ]
